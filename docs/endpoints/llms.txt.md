...
| `## Pages` | 20 of the 21 content pages, one line each — `/mcp` is deliberately listed under `## API & agent access` instead, as the endpoint it mostly is |
...
The `## API & agent access` list names **all ten public data APIs** — weather,
water, fishing, tropics, pollen, air, traffic, news, calendar, burn-ban — plus the OpenAPI
